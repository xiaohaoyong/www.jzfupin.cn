...
class Admin extends Base {
	...
	public function __construct() {
		parent::__construct();
		$this->isAdminLogin();
		$this->field = iaeweb::load_class('field');
	    ...
	    $go = iaeweb::get_controller_id() . '-' .iaeweb::get_action_id();
    ...
    protected function isAdminLogin() {
        if (iaeweb::get_controller_id() == 'login') return false;
    ...
    protected function admin_tpl($file) {
        return  IAEWEB_ADMIN . 'template' . DIRECTORY_SEPARATOR . $file.'.tpl.php';
    }
