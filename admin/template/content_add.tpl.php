...
<div class="subnav">
		...
		<?php }  if ($this->content_model[$modelid]['setting']['default']['seourl']['show']) { ?>
		<tr>
			<th><?php echo $this->content_model[$modelid]['setting']['default']['seourl']['name']; ?>：</th>
			<td><input type="text" class="input-text" size="80" id="seourl" value="<?php echo $data['seourl']; ?>" name="data[seourl]"><span class="onShow">自定义文章url</span></td>
		</tr>
		...
		<tr>
			...
			<td><textarea style="width:490px;height:44px;" maxlength="255" id="description" name="data[description]"><?php echo $data['description']; ?></textarea><span class="onShow">运营人员在此改问答，记录ID</span></td>
		</tr>
