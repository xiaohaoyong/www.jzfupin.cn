...
<div class="subnav">
	...
	<div class="bk10"></div>
		...
		<tr>
			...
			<?php }  ?>
			<?php } ?>
			<a href="<?php echo url('content/edit',array('id'=>$t['id'])); ?>"><?php echo $t['title']; ?><?php echo $t['phone']; ?></a>
			</td>
			<td align="left"><a href="<?php echo url('content/index',array('catid'=>$t['catid'])); ?>"><?php echo $this->category_cache[$t['catid']]['catname']; ?></a></td>

			<td align="left"><a href="<?php echo url('content/index',array('username'=>$t['username'],'catid'=>$t['catid'])); ?>"><?php echo $t['name']; ?></a></td>
