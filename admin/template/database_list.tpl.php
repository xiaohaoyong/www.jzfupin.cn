...
<thead class="m-table-thead s-table-thead">
	...
	<td align="left"><input <?php if ($v['xiaosys']) echo 'class="selectform"';?> type="checkbox" name="table[]" value="<?php echo $v['Name']?>"/>
	  <?php if ($v['xiaosys']) echo '<font color="#c00">iAEweb系统表</font>'; else echo '<font color="#369">其他系统表</font>';?></td>
	...
	?>
    <tr >
	<td colspan="6" align="left">选择iAEweb系统表&nbsp;&nbsp;<input name="selectform" class="cselectform" type="checkbox" onClick="setdb()">
