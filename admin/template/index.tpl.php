...
<title><?php echo $this->site_config['site_name'];?> - 后台管理中心 - Powered by iAEweb</title>
<script src="http://libs.baidu.com/jquery/1.9.1/jquery.min.js"></script>
<style type="text/css">body, h1, h2, h3, ul, li, p { margin:0; padding:0; font-size:12px; font-family:arial,'Microsoft Yahei'; }
...
<div id="head">
  ...
  <div id="menu_position">
    <ul id="menu">
        <li id="_MP101" ><a href="javascript:_MP(101,'<?php echo url('index/main') ;?>');" >后台首页</a></li>
    	...
    	<?php } ?>
		<?php if (defined('IAEWEB_MEMBER') && $this->menu('member-index')) {  ?>
		...
		<li id="_MP201" ><a href="javascript:_MP(201,'<?php echo url('index/my') ;?>');">工具</a>
          <ul>
          <li id="_MP107" ><a href="javascript:_MP(201,'<?php echo url('index/cache') ;?>');" >更新缓存</a></li>
		  <?php if($this->menu('database-index')) { ;?>
          <li id="_MP403" ><a href="javascript:_MP(201,'<?php echo url('database') ;?>');" >数据备份</a></li>
		  <?php } ;?>
		  <?php if($this->menu('models-index')) { ;?>
          <li id="_MP1046" ><a href="javascript:_MP(201,'<?php echo url('models') ;?>');" >内容模型</a></li>
          <li id="_MP1047" ><a href="javascript:_MP(201,'<?php echo url('models', array('typeid'=>3)) ;?>');" >表单模型</a></li>
          <li id="_MP1048" ><a href="javascript:_MP(201,'<?php echo url('models', array('typeid'=>4)) ;?>');" >自定义表</a></li>
		  <?php } ;?>
		  <li id="_MP403" ><a href="javascript:_MP(201,'<?php echo url('uploadfile/manager') ;?>');" >附件管理</a></li>
		  <li id="_MP404" ><a href="javascript:_MP(201,'<?php echo url('tool') ;?>');" >批量替换</a></li>
		  <li id="_MP405" ><a href="javascript:_MP(201,'<?php echo url('tool/filters') ;?>');" >过滤工具</a></li>
		  <li class="menubtm"></li>
          </ul>
        </li>
		<li id="_MP301" ><a href="javascript:_MP(301,'<?php echo url('spider') ;?>');">采集</a>
		</li>
   </ul>
  </div>
  <!--账户信息-->
  ...
  <div id="right">
    <div id="home">
    	<div id="shortcut">
    		...
    		<span>
    			<a  href="javascript:_MP(107,'<?php echo url('index/main'); ?>');" title="后台首页"  target="_blank" ><img width="16" height="16" src="./img/home.gif" /></a>
    		</span>
    	</div>
