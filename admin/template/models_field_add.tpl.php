...
<div class="subnav">
	...
	<div class="bk10"></div>
		...
		<tr>
			...
			<td><input class="input-text" type="text" id="field" name="data[field]" value="<?php echo $data['field']; ?>" size="30" <?php if ($data[fieldid]) { ?>disabled<?php } ?> /><div class="onShow">必须英文字母开头、数字和下划线组成。如：iaeweb</div>
		</tr>
		
		<tr>
			<th>字段类型： </th>
			<td><input class="input-text" type="text" id="type" name="data[inputtype]" value="<?php echo $data['inputtype']; ?>" size="30" /><div class="onShow">前端使用默认是text。如：移动端 数字 tel 密码 password</div>
		</tr>
