...
class field
{
	...
	<tr  id="editor_diy"  ' . ($setting['toolbar'] != 2 ? 'style="display:none" ' : '') . ' > 
      <th>自定义配置：</th>
      <td><textarea name="data[setting][items]"  rows="5" cols="70" class="text">' . $setting['items'] . '</textarea><br/><font color="gray"><a href="http://www.iaeweb.com/X1help/9.html" target="_blank"  class="green">点击这里查看配置帮助文档</a></font></td>
    </tr>
	...
	<tr> 
      ...
      <td><textarea name="data[setting][content]" style="width:400px;height:120px;" class="text">' . $setting['content'] . '</textarea><br/><font color="gray">格式：名称|赋值 (一行一个)。<a href="http://www.iaeweb.com/X1help/8.html" target="_blank"  class="green">详见帮助文档</a></font>
      </td>
    </tr>
	<tr> 
      <th>默认选中值 ：</th>
	...
	<tr> 
      ...
      <td><textarea name="data[setting][form]" rows="2" cols="20"  style="height:150px;width:600px;">' . $setting['form'] . '</textarea><br/><font color="gray"><a href="http://www.iaeweb.com/X1help/" target="_blank"  class="green">具体设计请看官方帮助文档</a></font></td>
    </tr>
	<tr> 
      <th >是否数组：</th>
	...
	<tr> 
      <th>附加js/css：</th>
      <td><textarea name="data[setting][jscss]" rows="2" cols="20"  style="height:150px;width:600px;">' . $setting['jscss'] . '</textarea><br/><font color="gray"><a href="http://www.iaeweb.com/X1help/" target="_blank"  class="green">如果有js或css可在此添加，也可以在外部添加，没有可忽略，具体可以看帮助文档</a></font></td>
    </tr>
	</table>';
    }
        ...
        if ($content) {
            ...
            if (is_array($fileurl) && !empty($fileurl)) {
                foreach ($fileurl as $id => $path) {
                    ...
                    $str .= '<img src="' . $fileurl[$id] . '" height="360px"/> <br />';
                    $str .= '<input type="hidden" class="input-text" style="width:450px;" value="' . $fileurl[$id] . '" name="data[' . $name . '][fileurl][]"  id="' . $name . $id . '" ' . $preview . '>';
