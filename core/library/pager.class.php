...
class pager
{
    ...
    public function select()
    {
        $data = $this->_processData();
        if (!$data) return null;
        $string = '<select name="iaeweb_select_pagelist" class="pagelist_select_box" onchange="self.location.href=this.options[this.selectedIndex].value">';
